...
def create_4_special_search_links(place, min_price=None, max_price=None, min_lot_size=None, max_lot_size=None, page_num=None):
    ...
    url3, meta3 = create_special_search_link(place, min_price, max_price, min_lot_size, max_lot_size, page_num, 2000, 2999)
    url4, meta4 = create_special_search_link(place, min_price, max_price, min_lot_size, max_lot_size, page_num, 3000, 4999)
    url5, meta5 = create_special_search_link(place, min_price, max_price, min_lot_size, max_lot_size, page_num, 5000, 15000)
    return [(url1, meta1), (url2, meta2), (url3, meta3), (url4, meta4), (url5, meta5)]
